...
class Config(BaseModel):
    ...
    sparkapi_app_id: str = "92538f77" # APP ID
    sparkapi_api_secret: str = "N2ZkZjJiNjhiZGRiZWE2NWMwYzk2Y2Rk" # API Secret
    sparkapi_api_key: str = "f3caf8e748eb0b3dafe4e98f7c747f51" # API Key

    # 模型设置
    sparkapi_model_version: str = "v1.5" # 星火大模型的版本，默认为当前最新。可选值：v3.5, v3.0, v2.0, v1.5
    ...
    sparkapi_fl_group_at: bool = False # 群聊中，回复时是否需要@提问者
